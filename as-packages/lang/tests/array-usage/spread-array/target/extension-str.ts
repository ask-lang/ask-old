 ...
 */
 import { FnParameters, msg, Storage, ReturnData, StoreMode, UInt32, Bool, UInt128, ScaleString, StorableArray, Int32, SpreadStorableArray} from "ask-lang";

 class ArrayTypes {
   _i8Arr   : SpreadStorableArray<ScaleString> | null = null;

   get i8Arr(): SpreadStorableArray<ScaleString> {
     if (this._i8Arr == null) {
       this._i8Arr = new SpreadStorableArray<ScaleString>("StorableArray.I8.0", 0);
     }
     return this._i8Arr!;
   }
 }
