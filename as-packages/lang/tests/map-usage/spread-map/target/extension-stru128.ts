import { FnParameters, msg, Storage, ReturnData, StoreMode, Bool, UInt128, u128, ScaleString, SpreadStorableMap} from "ask-lang";
/**
...
class MapTypes {
  _i8i8Map   : SpreadStorableMap<ScaleString, UInt128> | null = null;

  get i8i8Map(): SpreadStorableMap<ScaleString, UInt128> {
    if (this._i8i8Map === null) {
      this._i8i8Map = new SpreadStorableMap<ScaleString, UInt128>("StorableMap.I8I8.0");
    }
