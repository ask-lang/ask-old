...
class MapTypes {
  _i8i8Map   : SpreadStorableMap<UInt128, ScaleString> | null = null;

  get i8i8Map(): SpreadStorableMap<UInt128, ScaleString> {
    if (this._i8i8Map === null) {
      this._i8i8Map = new SpreadStorableMap<UInt128, ScaleString>("StorableMap.I8I8.0");
    }
