...
export class ScaleUInt128 implements UnwrappableCodec<u128> {
    ...
    @inline static get Zero(): ScaleUInt128 { return new ScaleUInt128(u128.Zero); }
    @inline static get One(): ScaleUInt128 { return new ScaleUInt128(u128.One); }
    @inline static get Min(): ScaleUInt128 { return new ScaleUInt128(new u128()); }
    @inline static get Max(): ScaleUInt128 { return new ScaleUInt128(new u128(-1, -1)); }
