import { FnParameters, msg, Storage, ReturnData, StoreMode, Bool, ScaleString, PackedStorableMap} from "ask-lang";
/**
...
class MapTypes {
  _i8i8Map   : PackedStorableMap<ScaleString, ScaleString> | null = null;

  get i8i8Map(): PackedStorableMap<ScaleString, ScaleString> {
    if (this._i8i8Map === null) {
      this._i8i8Map = new PackedStorableMap<ScaleString, ScaleString>("StorableMap.I8I8.0");
    }
