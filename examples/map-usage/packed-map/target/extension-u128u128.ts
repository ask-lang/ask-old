import { FnParameters, msg, Storage, ReturnData, StoreMode, Bool, UInt128, u128, PackedStorableMap} from "ask-lang";
/**
 * All Rights Reserved by Patract Labs.
 * @author liangqin.fan@gmail.com
 */
class MapTypes {
  _i8i8Map   : PackedStorableMap<UInt128, UInt128> | null = null;

  get i8i8Map(): PackedStorableMap<UInt128, UInt128> {
    if (this._i8i8Map === null) {
      this._i8i8Map = new PackedStorableMap<UInt128, UInt128>("StorableMap.I8I8.0");
    }
